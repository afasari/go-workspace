...
func (*ComplexMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_complex_048251f115505abd, []int{0}
}
...
func (*DummyMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_complex_048251f115505abd, []int{1}
}
...
func init() { proto.RegisterFile("complex/complex.proto", fileDescriptor_complex_048251f115505abd) }

var fileDescriptor_complex_048251f115505abd = []byte{
